"""
Complete Knowledge Graph Creation Pipeline - Simplified Version
================================================================
No httpx dependency - uses requests instead for OpenAI calls

Requirements:
pip install rdflib spacy networkx matplotlib python-docx PyPDF2 sentence-transformers numpy requests python-dotenv
...
import requests  # Using requests instead of openai package
...
# ============================================================================
# OpenAI API Helper (using requests instead of openai package)
# ============================================================================
...
class OpenAIHelper:
    ...
    def chat_completion(self, messages: List[Dict], temperature: float = 0, model: str = "gpt-3.5-turbo"):
